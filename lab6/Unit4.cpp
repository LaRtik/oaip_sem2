...
{
	StringGrid1->Cells[0][0] = "Зубенко Михаил Петрович";
	StringGrid1->Cells[1][0] = "8596";
	StringGrid1->Cells[0][1] = "Калыванов Иммануил Эдуардович";
	StringGrid1->Cells[1][1] = "7458";
	StringGrid1->Cells[0][2] = "Хумусов Пельмень Майонезов";
	StringGrid1->Cells[1][2] = "7854";
	StringGrid1->Cells[0][3] = "Кир Курседов Мидов";
	StringGrid1->Cells[1][3] = "2001";
	StringGrid1->Cells[0][4] = "Гуляев Гуль Гулевич";
